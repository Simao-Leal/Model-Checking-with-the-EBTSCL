...
final public class Implies extends Formula {
	private Formula inner1;
	private Formula inner2;

	
	public Implies(Formula inner1, Formula inner2) {
		this.inner1 = inner1;
		this.inner2 = inner2;
	}
	...
	@Override
	public Implies negate() {
		negation = !negation;
		return this;
	}
	
	@Override
	public Implies expand() {
		expanded = true;
		return this;
	}
	...
	public Implies clone() {
		Implies phi = new Implies(this.inner1.clone(), this.inner2.clone());
